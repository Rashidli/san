...
class ImageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('images.index')->with('message','Şəkil uğurla əlavə edildi');
    ...
    public function update(Request $request, Image $image)
    {
        ...
        return redirect()->back()->with('message','Şəkil uğurla yeniləndi');
    ...
    public function destroy(Image $image)
    {
        ...
        $image->delete();
        return redirect()->route('images.index')->with('message', 'Şəkil uğurla silindi');
