...
class SingleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('singles.index')->with('message','SEO uğurla əlavə edildi');
    ...
    public function update(Request $request, Single $single)
    {
        ...
        return redirect()->back()->with('message','SEO uğurla yeniləndi');
    ...
    public function destroy(Single $single)
    {
        ...
        return redirect()->route('singles.index')->with('message', 'SEO uğurla silindi');
