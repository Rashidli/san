...
//        Auth::login($user);
        ...
        return redirect()->route('users.index')->with('message', 'İstifadəçi uğurla əlavə edildi');
...
//        }
        ...
        return redirect()->back()->with('message','İstifadəçi uğurla yeniləndi');
    ...
    public function destroy(User $user)
    {
        ...
        $user->delete();
        return redirect()->route('users.index')->with('message','İstifadəçi uğurla silindi');
    }
}
