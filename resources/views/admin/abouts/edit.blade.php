                                    ...
                                    @foreach(['az', 'en', 'ru'] as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang }}" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" value="{{ old($lang . '_title', $about->translate($lang)?->title) }}" name="{{ $lang }}_title">
                                                @error("{$lang}_title")
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea id="editor1_{{ $lang }}" class="form-control" rows="10" name="{{ $lang }}_description">{{ old($lang . '_description', $about->translate($lang)?->description) }}</textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if($about->image)
                                    <div class="mb-3">
                                        <img src="{{ asset('storage/' . $about->image) }}" alt="" class="img-fluid rounded" style="max-height: 200px;">
                                    </div>
                                @endif
                                <div class="mb-3">
