...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Yeni Footer Səhifəsi</h4>
            ...
            <form action="{{ route('footer_pages.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control form-control-lg" type="text" value="{{ old($lang . '_title') }}" name="{{ $lang }}_title" placeholder="Səhifə başlığı...">
                                                        @error("{$lang}_title")
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="editor_{{ $lang }}" class="form-control summernote" name="{{ $lang }}_description" rows="10">{{ old($lang . '_description') }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select name="type" class="form-select">
                                        ...
                                        <option value="privacy_policy" {{ old('type') == 'privacy_policy' ? 'selected' : '' }}>Məxfilik Siyasəti</option>
                                        <option value="terms_of_use" {{ old('type') == 'terms_of_use' ? 'selected' : '' }}>İstifadəçi Razılaşması</option>
                                        <option value="rules" {{ old('type') == 'rules' ? 'selected' : '' }}>Qaydalar</option>
                                        <option value="support" {{ old('type') == 'support' ? 'selected' : '' }}>Dəstək</option>
                                    </select>
                                    @error('type')
