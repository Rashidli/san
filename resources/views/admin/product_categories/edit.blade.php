            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Kateqoriya Redakte</h4>
                                    ...
                                    @foreach(['az', 'en', 'ru'] as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang }}" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-lg" type="text" value="{{ old($lang . '_title', $productCategory->translate($lang)?->title) }}" name="{{ $lang }}_title" placeholder="Kateqoriya basliqi...">
                                                @error("{$lang}_title")
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    @if($productCategory->image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/'.$productCategory->image) }}" class="img-fluid rounded" style="max-height: 100px;">
                                        </div>
                                    @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" name="row" value="{{ old('row', $productCategory->row) }}">
                                </div>
