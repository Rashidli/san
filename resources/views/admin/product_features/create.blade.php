...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Yeni Xususiyyet</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('product_features.index') }}">Xususiyyetler</a></li>
            ...
            <form action="{{ route('product_features.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                                    ...
                                    @foreach(['az', 'en', 'ru'] as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang }}" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-lg" type="text" value="{{ old($lang . '_title') }}" name="{{ $lang }}_title" placeholder="Xususiyyet basliqi...">
                                                @error("{$lang}_title")
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2 mt-4">
                                    ...
                                    <a href="{{ route('product_features.index') }}" class="btn btn-outline-secondary">
