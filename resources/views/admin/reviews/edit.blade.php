                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="{{ old($lang . '_name', $review->translate($lang)?->name) }}" name="{{ $lang }}_name" placeholder="Müştəri adı...">
                                                        @error("{$lang}_name")
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="{{ old($lang . '_position', $review->translate($lang)?->position) }}" name="{{ $lang }}_position" placeholder="Direktor, Menecer və s.">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" rows="5" name="{{ $lang }}_content" placeholder="Müştəri rəyi...">{{ old($lang . '_content', $review->translate($lang)?->content) }}</textarea>
                                                        @error("{$lang}_content")
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    @if($review->image)
                                        <div class="mb-2 text-center">
                                            <img src="{{ asset('storage/' . $review->image) }}" style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;">
                                        </div>
                                    @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="rating">
                                        @for($i = 5; $i >= 1; $i--)
                                            <option value="{{ $i }}" {{ old('rating', $review->rating) == $i ? 'selected' : '' }}>{{ $i }} Ulduz</option>
                                        @endfor
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', $review->is_active) ? 'checked' : '' }}>
