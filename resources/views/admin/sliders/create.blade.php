                ...
                <div class="row">
                                    ...
                                    @foreach(['az', 'en', 'ru'] as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang }}" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" value="{{ old($lang . '_subtitle') }}" name="{{ $lang }}_subtitle">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="4" name="{{ $lang }}_description">{{ old($lang . '_description') }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Button Mətni</label>
                                                <input class="form-control" type="text" value="{{ old($lang . '_button_text') }}" name="{{ $lang }}_button_text">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label class="form-label">Slayder Şəkli <span class="text-danger">*</span></label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('button_link') }}" name="button_link" placeholder="/products">
                                </div>
                                <div class="mb-3">
