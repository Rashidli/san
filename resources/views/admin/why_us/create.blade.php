...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Yeni "Niyə Biz" elementi</h4>
            ...
            <form action="{{ route('why_us.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="{{ old($lang . '_title') }}" name="{{ $lang }}_title" placeholder="Başlıq...">
                                                        @error("{$lang}_title")
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="{{ $lang }}_description" placeholder="Qısa təsvir...">{{ old($lang . '_description') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="icon" value="{{ old('icon') }}" placeholder="fas fa-check">
